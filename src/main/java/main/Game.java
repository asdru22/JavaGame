...
public class Game {
    ...
    private void populate() {
        ...
        PlayableEntity p2 = PlayableEntity.getCharacter(PlayableEntity.Characters.ENEMY, gamePanel);
        PlayableEntity p3 = PlayableEntity.getCharacter(PlayableEntity.Characters.ENEMY, gamePanel);
